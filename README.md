...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/compas_skeleton-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15533&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/compas_skeleton-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `compas_skeleton` can be installed with:

```
conda install compas_skeleton
```

It is possible to list all of the versions of `compas_skeleton` available on your platform with:
